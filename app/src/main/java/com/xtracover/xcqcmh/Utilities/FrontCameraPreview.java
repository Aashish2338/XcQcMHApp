...
public class FrontCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public FrontCameraPreview(Context context, SurfaceView preview) {
        super(context);
        mContext = context;
        mPreview = preview;
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                try {
                    ...
                    if (uriTarget.toString() != null) {
                        ...
                        userSession.setFrontCameraImage(uriTarget.toString());
                        Toast.makeText(mContext, "Front A", Toast.LENGTH_SHORT).show();
                    } else {
                        userSession.setFrontCamera("0");
                        Toast.makeText(mContext, "Front B", Toast.LENGTH_SHORT).show();
                    }
